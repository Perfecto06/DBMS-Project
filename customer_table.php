            ...
            <table class="table table-hovered">
                ...
                <tbody>
                    ...
                    while($rows=$result->fetch_assoc()){
                        ?>
                        <tr>
                            <th scope="row"><input type="checkbox" value="room[]" name="<?php echo $rows['room_no1'];?>" /></th>
                ...
                <center><button type="submit" name="submit" value="Submit">DELETE SELECTED RECORDS</button></center>
            </table>
            </form>
            </div>
